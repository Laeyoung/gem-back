/**
 * ESM Integration Test for gemback
 *
...
async function main() {
  ...
  if (!apiKey) {
    ...
    console.log('✅ Import test passed - gemback is correctly loaded in ESM\n');
  ...
  try {
    ...
    const response = await client.generate('Say "Hello from ESM test!" in a friendly way.');
